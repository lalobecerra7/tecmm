  ...
  <body  style="overflow:hidden">
      ...
      <div class="row">
        ...
        <div class="col-md-4"><br><br>
					...
					<div class="card-header bg-secondary text-center" style="color:#000000";>Altas De Laboratorios</div>
						<div class="card-body">
					<h6 class="text-left">Nombre</h6>
					<div class="input-group">
						<span class="input-group-text"><i class="fas fa-id-badge"></i></span>
						<input type="text" class="form-control control"id="NombreLab" placeholder="Nombre del Laboratorio" onkeypress="return soloLetras(event)"onkeypress="if (event.keyCode == 13) enviar_formulario()"  value="">
					</div><br><br>
					<h6 class="text-left">Capacidad</h6>
					<div class="input-group">
						<span class="input-group-text"><i class="fas fa-hashtag"></i></span>
						<input type="text" class="form-control control" id="CapacidadLab" onkeypress="return valida(event)"  maxlength="2"  placeholder="Cantidad de alumnos" value="">
					</div><br><br>
			...
			$(document).on("click","#Guardar",function precionar(){
				if ($("#NombreLab").val()=='') {
  				...
  				type: 'warning',
					...
					swal({
						title: 'Estas Seguro?',
						text: "el registro de Laboratorios sera Guardado",
						type: 'warning',
						...
						if (result.value) {
							$.ajax({
								...
								data: ({
									funcion : "lab",
									nombre : $ ("#NombreLab").val(),
									capacidad : $ ("#NombreLab").val()
								}),
								dataType: "html",
								async:false,
