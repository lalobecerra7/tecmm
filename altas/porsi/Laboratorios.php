      ...
      <div class="row">
        <div class="col-md-6">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control control"name=""  placeholder="Nombre del Laboratorio" value="">
					</div><br><br>
					<h6 class="text-left">Capacidad</h6>
					<div class="input-group">
						<span class="input-group-text"><i class="fas fa-hashtag"></i></span>
						<input type="text" class="form-control control"name=""  placeholder="Cantidad de alumnos" value="">
					</div><br><br>
